...
namespace Generic
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            PersoN Mihajlo = new PersoN(1, "Mihajlo", "Dimovski", 45, Genre.HipHop, new List<Song>()
                {
                    new Song("Notorious",2,Genre.HipHop),
                    new Song("Zoshto?",4,Genre.HipHop),
                    new Song("BCheck the rhyme",3,Genre.HipHop)
                });
            PersoN Jerry = new PersoN(1, "Jerry", "G", 45, Genre.HipHop, new List<Song>()
                {
                    new Song("Notorious",2,Genre.HipHop),
                    new Song("Zoshto?",4,Genre.HipHop),
                    new Song("BCheck the rhyme",3,Genre.HipHop)
                });
            PersoN Marry = new PersoN(1, "Marry", "B", 45, Genre.HipHop, new List<Song>()
                {
                    new Song("Notorious",2,Genre.HipHop),
                    new Song("Zoshto?",4,Genre.HipHop),
                    new Song("BCheck the rhyme",3,Genre.HipHop)
            ...
            List<PersoN> listNames = new List<PersoN>();
            listNames.Add(Mihajlo);
            listNames.Add(Jerry);
            listNames.Add(Marry);
            listNames.Where(person=>person.name==Jerry)
